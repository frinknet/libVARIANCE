...
#define VCORE_APIURL   "https://openrouter.ai/api/v1/chat/completions"
...
#define VINFO_APIURL   	VCORE_APIURL
#define VINFO_APIKEY   	VCORE_APIKEY
#define VINFO_MODEL    	VCORE_MODEL
#define VINFO_INSTRUCT  "You are a source reviewer focused on summarizing code for busy developers."
...
#define VMARK_APIURL   	VCORE_APIURL
...
#define VCODE_APIURL   	VCORE_APIURL
...
#define VPLAN_APIURL   	VCORE_APIURL
#define VPLAN_APIKEY   	VCORE_APIKEY
#define VPLAN_MODEL    	VCORE_MODEL
#define VPLAN_INSTRUCT  "You are a {{language}} code reviewer focused on summarizing code for busydeveloper."
#define VPLAN_TIMEOUT  	VCORE_TIMEOUT
#define VPLAN_TOKENS    1000
#define VPLAN_TRIES	VCORE_TRIES
#define VPLAN_PAUSE    	VCORE_PAUSE
#define VPLAN_TEMP      0.3
